...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/material-design-lite/1.3.0/material.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/datatables/1.10.19/css/dataTables.material.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/jsoneditor/9.5.8/jsoneditor.min.css" rel="stylesheet" type="text/css">
    <!-- js -->
    <script src="https://cdnjs.cloudflare.com/jquery/3.6.0/jquery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/jsoneditor/9.5.8/jsoneditor.min.js"></script>
    <!-- favicon -->
    <!-- ... -->
    <style>
        body {
